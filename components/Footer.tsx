        ...
        <div className="grid md:grid-cols-2 gap-10 border-b border-white/10 pb-10 mb-10">
          ...
          <div className="md:text-right">
            ...
            <div className="space-y-1">
              <p className="text-white/60 text-xs md:text-sm">Law Chambers, Address Line 1</p>
              <p className="text-white/60 text-xs md:text-sm">City, State, ZIP</p>
              <p className="text-white/60 text-xs md:text-sm mt-3 pt-3 border-t border-white/5 md:border-0 inline-block md:block w-full">Email: info@advocatename.in</p>
            </div>
          </div>
        </div>
        <div className="flex flex-col md:flex-row justify-between items-center text-[8px] md:text-xs text-white/40 uppercase tracking-[0.2em] md:tracking-widest gap-6 text-center md:text-left">
